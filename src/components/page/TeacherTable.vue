...
export default {
  ...
  data() {
    return {
      ...
      id: -1,
      rules: {
        teacherName: [{ required: true, message: "请填写老师名字", trigger: "blur" }],
        mobileNumber: [{ required: true, message: "请填写老师手机号", trigger: "blur" }],
        introduction: [{ required: true, message: "请填写老师的介绍", trigger: "blur" }],
      },
    };
  },
  created() {
